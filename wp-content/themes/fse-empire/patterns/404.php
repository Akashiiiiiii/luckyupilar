 ...
 * Slug: fse-empire/not-found
 * Categories: fse-empire, not-found
 */
?>
...
<h2 class="has-text-align-center has-primary-color has-text-color" style="font-size:160px;letter-spacing:15px;line-height:1"><?php esc_html_e('404','fse-empire'); ?></h2>
<!-- /wp:heading -->

<!-- wp:heading {"textAlign":"center","level":4,"style":{"typography":{"letterSpacing":"2px","lineHeight":"1.2"}},"fontSize":"gigantic"} -->
<h4 class="has-text-align-center has-gigantic-font-size" style="letter-spacing:2px;line-height:1.2"><?php esc_html_e('Page not found!','fse-empire'); ?></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php esc_html_e('Sorry, the page you are looking for does not exist or has been moved.','fse-empire'); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="/" style="border-radius:0px"><?php esc_html_e('Return Home','fse-empire'); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->