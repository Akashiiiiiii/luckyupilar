...
/**
 * Title: Latest News
 * Slug: fse-empire/latest-news
 * Categories: fse-empire, latest-news
 */
?>
...
<h4 class="wp-block-heading has-text-align-center section_sub_title has-primary-color has-text-color" style="font-size:20px;font-style:normal;font-weight:500"><?php esc_html_e('RECENT NEWS','fse-empire'); ?></h4>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-text-align-center section_title has-big-font-size" style="margin-top:0px"><?php esc_html_e('Our Latest Case Detail News','fse-empire'); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<p><?php esc_html_e('There is no post found','fse-empire'); ?></p>
<!-- /wp:paragraph -->
